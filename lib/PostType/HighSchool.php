<?php
/**
 * The class representation of the post type 'high school'.
 */
 ...
 */
class HighSchool implements PostType {

    /**
     * This defines the slug of this post type.
     */
    public const SLUG = 'high-school-cpt';
    ...
    public function __construct() {
        ...
        $this->url_slug = 'high-schools';

        // Make possible description text translatable.
        $this->description = _x( 'Lukio', 'theme CPT', 'nuhe' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => _x( 'Lukiot', 'theme CPT', 'nuhe' ),
            'singular_name'         => _x( 'Lukio', 'theme CPT Singular Name', 'nuhe' ),
            'menu_name'             => _x( 'Lukiot', 'theme CPT', 'nuhe' ),
            'name_admin_bar'        => _x( 'Lukio', 'theme CPT', 'nuhe' ),
            'archives'              => _x( 'Lukioiden arkistot', 'theme CPT', 'nuhe' ),
            'attributes'            => _x( 'Lukion ominaisuudet', 'theme CPT', 'nuhe' ),
            'parent_item_colon'     => _x( 'Yläsivu:', 'theme CPT', 'nuhe' ),
            'all_items'             => _x( 'Kaikki lukiot', 'theme CPT', 'nuhe' ),
            'add_new_item'          => _x( 'Lisää uusi lukio', 'theme CPT', 'nuhe' ),
            ...
            'view_item'             => _x( 'Näytä lukio', 'theme CPT', 'nuhe' ),
