<?php
/**
 * The class representation of the post type 'youth center'.
 */
 ...
 */
class YouthCenter implements PostType {

    /**
     * This defines the slug of this post type.
     */
    public const SLUG = 'youth-center-cpt';
    ...
    public function __construct() {
        ...
        $this->url_slug = 'youth-centers';

        // Make possible description text translatable.
        $this->description = _x( 'Nuorisotalo', 'theme CPT', 'nuhe' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => _x( 'Nuorisotalot', 'theme CPT', 'nuhe' ),
            'singular_name'         => _x( 'Nuorisotalo', 'theme CPT Singular Name', 'nuhe' ),
            'menu_name'             => _x( 'Nuorisotalot', 'theme CPT', 'nuhe' ),
            'name_admin_bar'        => _x( 'Nuorisotalo', 'theme CPT', 'nuhe' ),
            'archives'              => _x( 'Nuorisotalojen arkistot', 'theme CPT', 'nuhe' ),
            'attributes'            => _x( 'Nuorisotalon ominaisuudet', 'theme CPT', 'nuhe' ),
            'parent_item_colon'     => _x( 'Yläsivu:', 'theme CPT', 'nuhe' ),
            'all_items'             => _x( 'Kaikki nuorisotalot', 'theme CPT', 'nuhe' ),
            'add_new_item'          => _x( 'Lisää uusi nuorisotalo', 'theme CPT', 'nuhe' ),
            ...
            'view_item'             => _x( 'Näytä nuorisotalo', 'theme CPT', 'nuhe' ),
    ...
    protected function fill_api_data( $post_id ) : void {
        ...
        $unit_id = get_field( 'unit', $post_id );
        ...
        update_field( 'latitude', $unit->get_latitude(), $post_id );
        update_field( 'longitude', $unit->get_longitude(), $post_id );
    }
}
