...
class Settings {
    ...
    public static function get_settings( string $lang = '', bool $raw = false ) {
        ...
        if ( $raw ) {
            $fields = \get_post_meta( $settings_page_id );
        }
        else {
            $fields = \get_fields( $settings_page_id );
        }
    ...
    public static function get_setting( string $field = '', string $lang = '', bool $raw = false ) {
        ...
        if ( $raw ) {
            $field = \get_post_meta( $settings_page_id, $field, true );
        }
        else {
            $field = \get_field( $field, $settings_page_id );
        }
    ...
    protected static function get_localised_settings_page_id( string $lang = '' ) {
        ...
        if ( empty( $lang ) ) {
            $lang_slug = Localization::get_current_language();
        }
        else {
            $lang_slug = $lang;
        }
